...
def recreate_database():
    """Create a backup of the current database and create a new one with the correct structure"""
    db_path = 'erp_system.db'
    backup_path = 'erp_system_backup.db'
    ...
    # Drop and recreate the returns tables
    print("Dropping returns-related tables...")
